 ...
 *
 */
package com.frojasg1.chesspdfbrowser.panels;
 ...
 */
public class ChessPdfViewerControlPanel extends com.frojasg1.general.desktop.view.panels.CustomJPanelBase
	implements ComposedComponent, PdfViewerControlView,
				NavigatorControllerInterface, InformerInterface
{
	protected ChessPdfViewerMaster _controller = null;
	 ...
	 */
	public ChessPdfViewerControlPanel() {
	}

	public void init( ChessPdfViewerMaster controller )
	{
		super.init();
...
//		ExecutionFunctions.instance().safeMethodExecution( () -> registerInternationalizedStrings() );
    ...
    private void initComponents() {
        ...
        jB_scanPDFforGames = new javax.swing.JButton();
        ...
        jTF_currentPage.setBounds(425, 40, 30, 20);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("/");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(455, 40, 10, 20);
        ...
        jTFTotalPages.setBounds(465, 40, 30, 20);
        ...
        jB_scanPDFforGames.setText("Scan PDF for games");
        jB_scanPDFforGames.setName("jB_scanPDFforGames"); // NOI18N
        jB_scanPDFforGames.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jB_scanPDFforGamesActionPerformed(evt);
            }
        });
        jPanel1.add(jB_scanPDFforGames);
        jB_scanPDFforGames.setBounds(360, 10, 180, 23);
    ...
    private void jB_scanPDFforGamesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_scanPDFforGamesActionPerformed
        // TODO add your handling code here:

		_controller.scanPDFforGamesActionPerformed();

    }//GEN-LAST:event_jB_scanPDFforGamesActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jB_scanPDFforGames;
