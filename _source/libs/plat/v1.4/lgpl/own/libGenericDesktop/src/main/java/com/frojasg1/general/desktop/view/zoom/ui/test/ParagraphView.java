...
public class ParagraphView extends FlowView implements TabExpander {
    ...
    protected static final String I18NProperty = "i18n";
	...
	{
		String result = null;
		if( Objects.equals( attributeName, "I18NProperty" ) )
			result = I18NProperty;
		else
			result = ReflectionFunctions.instance().getStaticAttribute( attributeName, String.class, AbstractDocument.class );
