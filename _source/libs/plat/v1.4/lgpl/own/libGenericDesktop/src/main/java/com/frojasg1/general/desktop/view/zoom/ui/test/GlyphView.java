...
//                    g2d,aci,x,y);
            ReflectionToJavaDesktop.instance().SwingUtilities2_drawString(getJComponent(v),
                    g2d,aci,x,y);
        }
    }
            ...
            if (// there's a highlighter (bug 4532590), and
                ...
                if(h.length != 0) {
                    ...
                    for (int i = 0; i < h.length; i++) {
                        ...
                        if (!ReflectionToJavaDesktop.instance().SwingUtilities2_useSelectedTextColor(highlight, tc)) {
