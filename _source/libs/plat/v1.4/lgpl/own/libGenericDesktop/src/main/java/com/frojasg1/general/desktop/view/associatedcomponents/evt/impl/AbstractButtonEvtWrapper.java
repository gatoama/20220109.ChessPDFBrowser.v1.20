 ...
 */
public class AbstractButtonEvtWrapper extends ComponentEvtWrapperSimpleDefaultBase<AbstractButton> {

	protected ActionListener _componentListener;

	public AbstractButtonEvtWrapper(AbstractButton component, Component parent) {
