...
//import com.frojasg1.sun.swing.DefaultLookup;
...
public abstract class BasicTextUI extends TextUI implements ViewFactory {
    ...
    protected Keymap createKeymap() {
        ...
        if (map == null) {
            ...
            Object o = DefaultLookup_get(editor, this, prefix + ".keyBindings");
...
//                prefix + ".keyBindings");
    ...
    {
        return( ReflectionToJavaDesktop.instance().DefaultLookup_get(jcomp, ui, var2) );
    }
    ...
    public Color DefaultLookUp_getColor(JComponent var0, ComponentUI var1, String var2, Color var3)
    {
        return( ReflectionToJavaDesktop.instance().DefaultLookUp_getColor(var0, var1, var2, var3) );
    }
    ...
    private void updateBackground(JTextComponent c) {
        ...
        if (background instanceof UIResource) {
            ...
            Color disabledBG =
                    DefaultLookUp_getColor(c, this, prefix + ".disabledBackground", null);
//            DefaultLookup.getColor(c, this, prefix + ".disabledBackground", null);
            Color inactiveBG =
                    DefaultLookUp_getColor(c, this, prefix + ".inactiveBackground", null);
//            DefaultLookup.getColor(c, this, prefix + ".inactiveBackground", null);
            Color bg =
                    DefaultLookUp_getColor(c, this, prefix + ".background", null);
//            DefaultLookup.getColor(c, this, prefix + ".background", null);
    ...
    private void installDefaults2() {
        ...
        if (caret == null || caret instanceof UIResource) {
            ...
            int rate = ReflectionToJavaDesktop.instance().DefaultLookup_getInt(getComponent(), this, prefix + ".caretBlinkRate", 500);
//            int rate = DefaultLookup.getInt(getComponent(), this, prefix + ".caretBlinkRate", 500);
    ...
    InputMap getInputMap() {
        ...
        InputMap shared =
                (InputMap)DefaultLookup_get(editor, this,
    ...
    private static DragListener getDragListener() {
        synchronized(DragListener.class) {
            DragListener listener =
                    (DragListener)  ReflectionToJavaDesktop.instance().AppContext_getAppContext_get(DragListener.class);
...
//                AppContext.getAppContext().put(DragListener.class, listener);
                ReflectionToJavaDesktop.instance().AppContext_getAppContext_put(DragListener.class, listener);
            }
