 ...
 */
public class ResizableImageJToggleButton extends JToggleButton
	implements ColorThemeInvertible, ResizableImage
{
	protected static final String CLASS_NAME="ResizableImageJToggleButton";

	protected ResizableImageButtonHelper _helper;

	public ResizableImageJToggleButton( String jarResourceName, Insets insets )
	{
	...
	protected BasicToggleButtonUI createUI()
	{
