...
class Label {
   ...
   void add(com.frojasg1.sun.reflect.ClassFileAssembler var1, short var2, short var3, int var4) {
   ...
   static class PatchInfo {
      final com.frojasg1.sun.reflect.ClassFileAssembler asm;
      final short instrBCI;
      final short patchBCI;
      final int stackDepth;

      PatchInfo(com.frojasg1.sun.reflect.ClassFileAssembler var1, short var2, short var3, int var4) {
         this.asm = var1;
         this.instrBCI = var2;
         this.patchBCI = var3;
