...
import com.frojasg1.sun.security.provider.ByteArrayAccess;
import com.frojasg1.sun.security.provider.DigestBase;

abstract class SHA5 extends com.frojasg1.sun.security.provider.DigestBase {
   ...
   final void implDigest(byte[] var1, int var2) {
      ...
      com.frojasg1.sun.security.provider.ByteArrayAccess.i2bBig4((int)(var3 >>> 32), this.buffer, 120);
      com.frojasg1.sun.security.provider.ByteArrayAccess.i2bBig4((int)var3, this.buffer, 124);
      this.implCompress(this.buffer, 0);
      com.frojasg1.sun.security.provider.ByteArrayAccess.l2bBig(this.state, 0, var1, var2, this.engineGetDigestLength());
   }
   ...
   final void implCompress(byte[] var1, int var2) {
      com.frojasg1.sun.security.provider.ByteArrayAccess.b2lBig128(var1, var2, this.W);
