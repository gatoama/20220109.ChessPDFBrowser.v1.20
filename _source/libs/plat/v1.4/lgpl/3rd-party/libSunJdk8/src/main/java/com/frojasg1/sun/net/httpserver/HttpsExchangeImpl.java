...
class HttpsExchangeImpl extends HttpsExchange {
   com.frojasg1.sun.net.httpserver.ExchangeImpl impl;

   HttpsExchangeImpl(com.frojasg1.sun.net.httpserver.ExchangeImpl var1) throws IOException {
      this.impl = var1;
   }
   ...
   com.frojasg1.sun.net.httpserver.ExchangeImpl getExchangeImpl() {
      return this.impl;
   }
}
