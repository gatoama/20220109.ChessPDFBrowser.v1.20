...
class PermissionActionsMenuListener implements ItemListener {
   ...
   PermissionActionsMenuListener(com.frojasg1.sun.security.tools.policytool.ToolDialog var1) {
      this.td = var1;
   }
   ...
   public void itemStateChanged(ItemEvent var1) {
      if (var1.getStateChange() != 2) {
         ...
         if (((String)var1.getItem()).indexOf(com.frojasg1.sun.security.tools.policytool.ToolDialog.PERM_ACTIONS) == -1) {
