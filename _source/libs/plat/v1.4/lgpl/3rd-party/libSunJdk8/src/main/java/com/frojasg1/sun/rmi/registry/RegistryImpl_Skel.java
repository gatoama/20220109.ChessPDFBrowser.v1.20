...
public final class RegistryImpl_Skel implements Skeleton {
   ...
   public void dispatch(Remote var1, RemoteCall var2, int var3, long var4) throws Exception {
      if (var4 != 4905912898345647071L) {
         ...
         com.frojasg1.sun.rmi.registry.RegistryImpl var6 = (com.frojasg1.sun.rmi.registry.RegistryImpl)var1;
         String var7;
         ObjectInput var8;
         ObjectInput var9;
         Remote var80;
         switch(var3) {
         case 0:
            com.frojasg1.sun.rmi.registry.RegistryImpl.checkAccess("Registry.bind");
         ...
         case 3:
            com.frojasg1.sun.rmi.registry.RegistryImpl.checkAccess("Registry.rebind");
