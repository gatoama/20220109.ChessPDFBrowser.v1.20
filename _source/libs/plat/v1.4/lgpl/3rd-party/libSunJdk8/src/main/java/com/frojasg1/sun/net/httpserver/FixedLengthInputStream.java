...
class FixedLengthInputStream extends com.frojasg1.sun.net.httpserver.LeftOverInputStream {
   private long remaining;

   FixedLengthInputStream(com.frojasg1.sun.net.httpserver.ExchangeImpl var1, InputStream var2, long var3) {
      super(var1, var2);
      this.remaining = var3;
   }
