...
public interface LangReflectAccess {
   ...
   com.frojasg1.sun.reflect.MethodAccessor getMethodAccessor(Method var1);

   void setMethodAccessor(Method var1, MethodAccessor var2);

   com.frojasg1.sun.reflect.ConstructorAccessor getConstructorAccessor(Constructor<?> var1);
