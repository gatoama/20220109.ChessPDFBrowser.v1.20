...
final class CGITryHostnameCommand implements com.frojasg1.sun.rmi.transport.proxy.CGICommandHandler {
   ...
   public void execute(String var1) {
      ...
      System.out.println("<P>SERVER_NAME = " + com.frojasg1.sun.rmi.transport.proxy.CGIHandler.ServerName);
