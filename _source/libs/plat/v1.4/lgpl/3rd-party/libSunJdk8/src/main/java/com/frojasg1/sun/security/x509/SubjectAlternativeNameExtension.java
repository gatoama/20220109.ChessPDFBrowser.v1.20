...
public class SubjectAlternativeNameExtension extends Extension implements CertAttrSet<String> {
   ...
   com.frojasg1.sun.security.x509.GeneralNames names;
   ...
   public SubjectAlternativeNameExtension(com.frojasg1.sun.security.x509.GeneralNames var1) throws IOException {
      this(Boolean.FALSE, var1);
   }

   public SubjectAlternativeNameExtension(Boolean var1, com.frojasg1.sun.security.x509.GeneralNames var2) throws IOException {
      this.names = null;
      this.names = var2;
      this.extensionId = com.frojasg1.sun.security.x509.PKIXExtensions.SubjectAlternativeName_Id;
      this.critical = var1;
      this.encodeThis();
   }
