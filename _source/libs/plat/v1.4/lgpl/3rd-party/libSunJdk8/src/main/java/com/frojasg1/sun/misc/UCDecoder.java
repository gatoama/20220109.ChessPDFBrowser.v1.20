...
import com.frojasg1.sun.misc.CEFormatException;
import com.frojasg1.sun.misc.CEStreamExhausted;
import com.frojasg1.sun.misc.CRC16;
import com.frojasg1.sun.misc.CharacterDecoder;
...
public class UCDecoder extends CharacterDecoder {
   ...
   private com.frojasg1.sun.misc.CRC16 crc = new CRC16();
   ...
   protected void decodeAtom(PushbackInputStream var1, OutputStream var2, int var3) throws IOException {
      ...
      if (var4 != 3) {
         throw new com.frojasg1.sun.misc.CEStreamExhausted();
      } else {
         ...
         if ((var5 & 1) != var7) {
            throw new com.frojasg1.sun.misc.CEFormatException("UCDecoder: High byte parity error.");
         } else if ((var6 & 1) != var8) {
            throw new com.frojasg1.sun.misc.CEFormatException("UCDecoder: Low byte parity error.");
         } else {
            var2.write(var12);
   ...
   protected int decodeLinePrefix(PushbackInputStream var1, OutputStream var2) throws IOException {
      ...
      if (var5 != this.sequence) {
         throw new com.frojasg1.sun.misc.CEFormatException("UCDecoder: Out of sequence line.");
      } else {
