...
import com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMeta;
...
public class JvmMemMgrPoolRelTableMeta extends SnmpMibTable implements Serializable {
   ...
   private com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMeta node;
   ...
   protected com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMeta createJvmMemMgrPoolRelEntryMetaNode(String var1, String var2, SnmpMib var3, MBeanServer var4) {
   ...
   public synchronized void addEntry(SnmpOid var1, ObjectName var2, Object var3) throws SnmpStatusException {
      if (!(var3 instanceof com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMBean)) {
   ...
   public void get(SnmpMibSubRequest var1, SnmpOid var2, int var3) throws SnmpStatusException {
      com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMBean var4 = (com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMBean)this.getEntry(var2);
      synchronized(this) {
   ...
   public boolean skipEntryVariable(SnmpOid var1, long var2, Object var4, int var5) {
      try {
         com.frojasg1.sun.management.snmp.jvmmib.JvmMemMgrPoolRelEntryMBean var6 = (JvmMemMgrPoolRelEntryMBean)this.getEntry(var1);
         synchronized(this) {
