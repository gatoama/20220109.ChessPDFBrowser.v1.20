...
public final class Aes128CtsHmacSha1EType extends EType {
   ...
   public int checksumSize() {
      return com.frojasg1.sun.security.krb5.internal.crypto.Aes128.getChecksumLength();
   }
   ...
   public byte[] encrypt(byte[] var1, byte[] var2, byte[] var3, int var4) throws KrbCryptoException {
      try {
         return com.frojasg1.sun.security.krb5.internal.crypto.Aes128.encrypt(var2, var4, var3, var1, 0, var1.length);
