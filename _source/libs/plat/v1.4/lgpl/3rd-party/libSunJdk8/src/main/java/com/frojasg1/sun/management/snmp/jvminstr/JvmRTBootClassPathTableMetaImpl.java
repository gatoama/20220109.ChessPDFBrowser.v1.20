...
import com.frojasg1.sun.management.snmp.jvminstr.JvmRTBootClassPathEntryImpl;
      ...
      if (var1 != null && var1.getLength() == 1) {
         ...
         if (var8 == null) {
            ...
            if (var6 == null) {
               ...
               com.frojasg1.sun.management.snmp.jvminstr.JvmRTBootClassPathEntryImpl var7 = new JvmRTBootClassPathEntryImpl((String)var6, (int)var1.getOidArc(0));
