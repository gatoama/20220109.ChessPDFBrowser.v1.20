...
class PrintStreamProbe extends ProbeSkeleton {
   private com.frojasg1.sun.tracing.PrintStreamProvider provider;
   private String name;

   PrintStreamProbe(com.frojasg1.sun.tracing.PrintStreamProvider var1, String var2, Class<?>[] var3) {
      super(var3);
      this.provider = var1;
      this.name = var2;
   }
