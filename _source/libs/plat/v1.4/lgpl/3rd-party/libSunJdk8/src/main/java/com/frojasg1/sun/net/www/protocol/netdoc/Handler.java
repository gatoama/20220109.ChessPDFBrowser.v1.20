package com.frojasg1.sun.net.www.protocol.netdoc;
...
public class Handler extends URLStreamHandler {
   ...
   public synchronized URLConnection openConnection(URL var1) throws IOException {
      ...
      Boolean var4 = (Boolean)AccessController.doPrivileged(new GetBooleanAction("newdoc.localonly"));
      boolean var5 = var4;
      String var6 = (String)AccessController.doPrivileged(new GetPropertyAction("doc.url"));
