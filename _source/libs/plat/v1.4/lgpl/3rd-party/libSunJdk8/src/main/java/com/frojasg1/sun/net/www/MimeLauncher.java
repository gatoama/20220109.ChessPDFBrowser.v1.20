...
import com.frojasg1.sun.net.www.ApplicationLaunchException;
...
class MimeLauncher extends Thread {
   ...
   com.frojasg1.sun.net.www.MimeEntry m;
   String genericTempFileTemplate;
   InputStream is;
   String execPath;

   MimeLauncher(MimeEntry var1, java.net.URLConnection var2, InputStream var3, String var4, String var5) throws com.frojasg1.sun.net.www.ApplicationLaunchException {
      super(var5);
      this.m = var1;
      this.uc = var2;
      this.is = var3;
