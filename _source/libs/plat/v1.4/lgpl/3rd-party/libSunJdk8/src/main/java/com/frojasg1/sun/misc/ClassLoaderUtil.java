...
public class ClassLoaderUtil {
   ...
   public static List<IOException> releaseLoader(URLClassLoader var0, List<String> var1) {
      ...
      try {
         ...
         com.frojasg1.sun.misc.URLClassPath var3 = SharedSecrets.getJavaNetAccess().getURLClassPath(var0);
         ...
         synchronized(var3) {
            ...
            while(true) {
               ...
               } while(!(var9 instanceof com.frojasg1.sun.misc.URLClassPath.JarLoader));

               com.frojasg1.sun.misc.URLClassPath.JarLoader var10 = (URLClassPath.JarLoader)var9;
