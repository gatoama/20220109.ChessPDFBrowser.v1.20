...
public class OGLDrawImage extends DrawImage {
   ...
   protected void renderImageXform(SunGraphics2D var1, Image var2, AffineTransform var3, int var4, int var5, int var6, int var7, int var8, Color var9) {
      if (var4 != 3) {
         ...
         if (var11 != null && !isBgOperation(var11, var9) && (var11.getSurfaceType() == com.frojasg1.sun.java2d.opengl.OGLSurfaceData.OpenGLTexture || var11.getSurfaceType() == OGLSurfaceData.OpenGLSurfaceRTT || var4 == 1)) {
   ...
   public void transformImage(SunGraphics2D var1, BufferedImage var2, BufferedImageOp var3, int var4, int var5) {
      if (var3 != null) {
         ...
         if (com.frojasg1.sun.java2d.opengl.OGLBufImgOps.renderImageWithOp(var1, var2, var3, var4, var5)) {
            return;
         }
