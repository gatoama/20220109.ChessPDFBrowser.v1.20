...
public final class Des3CbcHmacSha1KdEType extends EType {
   ...
   public int checksumSize() {
      return com.frojasg1.sun.security.krb5.internal.crypto.Des3.getChecksumLength();
   }
   ...
   public byte[] encrypt(byte[] var1, byte[] var2, byte[] var3, int var4) throws KrbCryptoException {
      try {
         return com.frojasg1.sun.security.krb5.internal.crypto.Des3.encrypt(var2, var4, var3, var1, 0, var1.length);
