...
import com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMBean;
import com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMeta;
...
public class JvmThreadInstanceTableMeta extends SnmpMibTable implements Serializable {
   ...
   private com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMeta node;
   ...
   protected com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMeta createJvmThreadInstanceEntryMetaNode(String var1, String var2, SnmpMib var3, MBeanServer var4) {
   ...
   public synchronized void addEntry(SnmpOid var1, ObjectName var2, Object var3) throws SnmpStatusException {
      if (!(var3 instanceof com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMBean)) {
   ...
   public void get(SnmpMibSubRequest var1, SnmpOid var2, int var3) throws SnmpStatusException {
      com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMBean var4 = (com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMBean)this.getEntry(var2);
      synchronized(this) {
   ...
   public boolean skipEntryVariable(SnmpOid var1, long var2, Object var4, int var5) {
      try {
         com.frojasg1.sun.management.snmp.jvmmib.JvmThreadInstanceEntryMBean var6 = (JvmThreadInstanceEntryMBean)this.getEntry(var1);
         synchronized(this) {
