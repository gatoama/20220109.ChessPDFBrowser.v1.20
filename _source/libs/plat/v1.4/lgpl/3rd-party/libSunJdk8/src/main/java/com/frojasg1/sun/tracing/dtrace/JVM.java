...
class JVM {
   ...
   static long activate(String var0, com.frojasg1.sun.tracing.dtrace.DTraceProvider[] var1) {
   ...
   private static native long activate0(String var0, com.frojasg1.sun.tracing.dtrace.DTraceProvider[] var1);
