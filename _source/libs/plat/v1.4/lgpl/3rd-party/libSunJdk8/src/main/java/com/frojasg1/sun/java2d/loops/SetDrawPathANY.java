...
class SetDrawPathANY extends DrawPath {
   ...
   public void DrawPath(SunGraphics2D var1, SurfaceData var2, int var3, int var4, Float var5) {
      com.frojasg1.sun.java2d.loops.PixelWriter var6 = GeneralRenderer.createSolidPixelWriter(var1, var2);
      ProcessPath.drawPath(new com.frojasg1.sun.java2d.loops.PixelWriterDrawHandler(var2, var6, var1.getCompClip(), var1.strokeHint), var5, var3, var4);
   }
}
