...
public final class ArcFourHmacEType extends EType {
   ...
   public int checksumSize() {
      return com.frojasg1.sun.security.krb5.internal.crypto.ArcFourHmac.getChecksumLength();
   }
   ...
   public byte[] encrypt(byte[] var1, byte[] var2, byte[] var3, int var4) throws KrbCryptoException {
      try {
         return com.frojasg1.sun.security.krb5.internal.crypto.ArcFourHmac.encrypt(var2, var4, var3, var1, 0, var1.length);
