...
import com.frojasg1.sun.security.pkcs.ESSCertId;
import com.frojasg1.sun.security.util.DerValue;

public class SigningCertificateInfo {
   private byte[] ber = null;
   private com.frojasg1.sun.security.pkcs.ESSCertId[] certId = null;
   ...
   public void parse(byte[] var1) throws IOException {
      ...
      if (var2.tag != 48) {
         ...
         this.certId = new com.frojasg1.sun.security.pkcs.ESSCertId[var3.length];

         for(int var4 = 0; var4 < var3.length; ++var4) {
            this.certId[var4] = new com.frojasg1.sun.security.pkcs.ESSCertId(var3[var4]);
         }
