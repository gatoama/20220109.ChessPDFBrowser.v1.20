...
class CacheEnumerator implements Enumeration {
   boolean keys;
   int index;
   com.frojasg1.sun.misc.CacheEntry[] table;
   com.frojasg1.sun.misc.CacheEntry entry;

   CacheEnumerator(com.frojasg1.sun.misc.CacheEntry[] var1, boolean var2) {
      this.table = var1;
      this.keys = var2;
   ...
   public Object nextElement() {
      while(this.index >= 0) {
         ...
         if (this.entry != null) {
            com.frojasg1.sun.misc.CacheEntry var1 = this.entry;
