...
class VersionInfo extends Object {
     ...
     */
    static final boolean isDebug = true; // ${is_debug};
     ...
     */
	static final boolean isDevPhase = true; // ${is_dev_phase};
     ...
     */
	static final boolean isProduction = false; //  ${is_production};
     ...
     * default value is true.
     */
	private static final boolean useVerboseBuildTime = true; //  ${use_verbose_buildtime};
