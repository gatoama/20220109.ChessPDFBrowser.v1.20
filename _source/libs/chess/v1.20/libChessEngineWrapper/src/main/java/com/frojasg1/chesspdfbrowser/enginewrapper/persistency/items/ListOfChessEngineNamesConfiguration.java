 ...
 */
public class ListOfChessEngineNamesConfiguration extends ParameterListConfiguration
{
	public static final String GLOBAL_CONF_FILE_NAME = "ChessPatternItems.properties";


	// function for DefaultConstructorInitCopier
	public ListOfChessEngineNamesConfiguration()
	{
		
	}

	public ListOfChessEngineNamesConfiguration( BaseApplicationConfigurationInterface appConf )
	{
		this(appConf,
			DefaultConstantsForChessEngineConf.CONF_CHESS_ENGINE_MAIN_FOLDER_DEFAULT,
	...
	// function for DefaultConstructorInitCopier
	public void init( ListOfChessEngineNamesConfiguration that )
	{
