...
{
	protected static final double VALUE = 5d;
	public static final String PIECE_TYPE_CODE="R";

	public Rook( ChessBoard chessBoard, int color )
	{
	...
	public boolean isProbablyLegalThisMove_child( ChessGameMove cgm, boolean weKnowIfIsACaptureMoveOrNot ) throws ChessMoveException
	{
		...
		if( ( (cgm._deltaColumn == 0) && (cgm._deltaRow != 0 ) ) ||
