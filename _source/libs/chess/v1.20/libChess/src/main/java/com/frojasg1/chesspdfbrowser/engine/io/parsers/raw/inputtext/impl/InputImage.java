...
import com.frojasg1.chesspdfbrowser.engine.io.parsers.raw.inputtext.InputElementBase;
 ...
 */
public class InputImage extends InputElementBase
{
	protected ImageWrapper _image = null;
	protected Point _pointToStartRecognition = null;

	public InputImage( ImageWrapper image, Point pointToStartRecognition, SegmentKey segmentKey )
	{
		super( segmentKey );
		_image = image;
